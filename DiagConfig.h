...
enum : uint32_t {
  ...
  DBG_ARCHIVE   = 1u << 10, // raw TAR archive streaming
...
//(DBG_MEM | DBG_FS | DBG_PUMPLOG | DBG_TEMPLOG | DBG_ALARMLOG | DBG_1WIRE | DBG_RTD | DBG_NET | DBG_PUMP | DBG_RTC | DBG_ARCHIVE | DBG_TIMESYNC | DBG_WEB | DBG_TASK | DBG_SENSOR | DBG_CONFIG | DBG_PERF | DBG_PUMP_RUN_TIME_UI);
...
// Removed DBG_RTC because it reports every 5 seconds (when the sensor is read) to the Serial Monitor
  (DBG_MEM | DBG_FS | DBG_PUMPLOG | DBG_TEMPLOG | DBG_ALARMLOG | DBG_1WIRE | DBG_NET | DBG_PUMP | DBG_RTC | DBG_ARCHIVE | DBG_TIMESYNC | DBG_WEB | DBG_TASK | DBG_SENSOR | DBG_CONFIG | DBG_PERF | DBG_PUMP_RUN_TIME_UI);
