...
We have unsuccessfully made many changes some helpful and some not helpful over the last two weeks of attempting to resolve the ws client disconnects and the W5500 truncated frame errors
