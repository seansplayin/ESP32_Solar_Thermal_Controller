...
#include "freertos/FreeRTOS.h"  // StackType_t
...
namespace TarGZ {
  ...
  // Registers compressed download routes:
  //   /fs/download_compressed
  //   /fs/download_compressed/info
  //   /fs/download_compressed/status
  //   /fs/download_compressed/cancel
